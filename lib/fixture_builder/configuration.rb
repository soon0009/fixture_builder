...
module FixtureBuilder
  class Configuration
    ...
    ACCESSIBLE_ATTRIBUTES = [:select_sql, :delete_sql, :skip_tables, :files_to_check, :record_name_fields,
                             :fixture_builder_file, :after_build, :legacy_fixtures, :model_name_procs, :fixtures_path]
    ...
    def fixtures_dir(path = '')
      File.expand_path(File.join(::Rails.root, spec_or_test_dir, fixtures_path, path))
    end
